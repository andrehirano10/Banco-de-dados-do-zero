...
create table funcionario (
    ...
    constraint fk_funcionario_veiculo foreign key (idveiculo) references veiculo (idveiculo)
);
...
create table mecanico_ordemservico (
	idfuncionario int,funcionario
    idordemservico int,
    constraint fk_ordemservico_funcionario foreign key (idmecanico) references funcionario(idfuncionario),
