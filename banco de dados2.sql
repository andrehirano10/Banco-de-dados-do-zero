...
insert into funcionario (idveiculo, nome, endereco, especialidade) values
	(4,'mecanico 4','endereco funcionario 4','especialidade mecanico 4'),
    (1,'mecanico 1','endereco funcionario 1','especialidade mecanico 1'),
    (3,'mecanico 3','endereco funcionario 3','especialidade mecanico 3'),
    (2,'mecanico 2','endereco funcionario 2','especialidade mecanico 2');
    
select * from funcionario;
select m.nome,m.especialidade,v.placa,v.marca from funcionario as m, veiculo as v 
...
insert into funcionario_ordemservico values
	(2,6),
    (1,7),
    (3,8),
    (4,9),
